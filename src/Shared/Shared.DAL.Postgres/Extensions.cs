...
public static class Extensions
{
        ...
        where T : DbContext
    {
        ...
        if (!section.Exists())
            throw new InvalidOperationException(
                "You should append the postgres configuration section to your appsettings.json file");
    ...
    public static IServiceCollection AddDataInitializer<T>(this IServiceCollection services)
        where T : class, IDataInitializer
    {
        return services.AddTransient<IDataInitializer, T>();
    }
}