...
public class PlaceBetCommandHandler : ICommandHandler<PlaceBetCommand>
{
    ...
    public PlaceBetCommandHandler(ILogger<PlaceBetCommandHandler> logger, ISlipRepository slipRepository,
        IContext context, IBusPublisher publisher, IEventDispatcher eventDispatcher)
    {
        _logger = logger;
