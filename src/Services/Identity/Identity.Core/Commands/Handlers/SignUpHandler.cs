...
internal class SignUpHandler : ICommandHandler<SignUp>
{
    ...
    public SignUpHandler(IUtcClock clock, IRoleRepository roleRepository, IUserRepository userRepository, IPasswordManager passwordManager, ILogger<SignUpHandler> logger)
    {
        _clock = clock;
